...
$roles = [
    'admin' => [
        ...
        'dest' => '/FinalSystem/pos-cafe/pages/dashboard/index.php',
        'duration'  => '1.8s',
    ...
    'barista' => [
        ...
        'dest'      => '/FinalSystem/pos-cafe/orders/board',
        'duration'  => '1.4s',
...
<title>Loading â€” Bird's Nest Coffee</title>
...
/* Idle spinner â€” shown before JS progress starts */
.ring-spinner {
    fill: none;
    stroke: var(--accent);
    stroke-width: 3;
...
<div class="wrapper" id="wrapper">
    ...
    <div class="brand">
        ...
        <span class="brand-text">Bird's Nest Coffee <span class="brand-dot">Â·</span> <span class="brand-portal"><?= htmlspecialchars($portal) ?></span></span>
    </div>
...
// Update tagline with live data â€” shown data is gated by role
function updateTagline(data) {
    ...
    if (role === 'barista') {
        ...
        text = data.active_orders + ' active Â· ' + sales + ' today';
    }
    // staff (cashier): tagline stays as-is â€” no revenue or analytics exposure
...
async function run() {
    // â”€â”€ Fast: cashier (<1s total) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    if (speed === 'fast') {
        spinEl.style.display = 'none';
        // Fire preload in background â€” don't block redirect on it
    ...
    // â”€â”€ Medium: inventory (~1.5s total) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    if (speed === 'medium') {
        spinEl.style.display = 'none';
        barLabel.textContent = initLabel;
        ...
        const fetchMed = fetch('api/preload.php')
            ...
            .catch(() => {
                errEl.textContent = 'Connection issue â€” continuing anyway';
    ...
    // â”€â”€ Normal: admin / manager / supervisor â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    await wait(600);
    spinEl.style.display = 'none';
