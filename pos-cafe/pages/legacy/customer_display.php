...
<title>Order Status â€” Bird's Nest Coffee</title>
...
<div class="topbar">
    ...
    <div class="topbar-right">
        ...
        <a href="/FinalSystem/pos-cafe/pages/dashboard/index.php" class="back-btn"><i class="fa-solid fa-arrow-left"></i> Back</a>
    </div>
</div>

<div class="legend">
    <div class="legend-item"><span class="legend-dot preparing"></span> Preparing â€” Your order is being made</div>
    <div class="legend-item"><span class="legend-dot ready"></span> Ready â€” Please collect your order</div>
</div>

<div class="filter-bar">
    <div class="filter-left" id="orderCount">Loadingâ€¦</div>
...
<script>
const readyAt       = new Map();  // order_id â†’ JS ms when first became Completed
...
// Patch an existing card's status in-place â€” zero flicker, no DOM removal
...
async function refresh() {
    try {
        ...
        // Fade-out cards that left or expired â€” don't touch anything else
        ...
        visible.forEach((o, idx) => {
            ...
            if (existing) {
                ...
                // Brand-new card â€” fade in quietly
        ...
        document.getElementById('orderCount').textContent = `${nPrep} preparing Â· ${nReady} ready`;
