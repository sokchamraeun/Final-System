...
// Cashiers (staff) handle pay-later orders (add-to-order + settle) â€” allow them alongside admin/manager
...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* top accent â€” static, single hairline */
        .tab-card::before {
            content: '';
            position: absolute;
        ...
        /* â”€â”€ Emblem (single, merged cup + check) â”€â”€ */
        .emblem {
            position: relative;
        ...
        /* â”€â”€ Meta row (order / customer) â”€â”€ */
        .meta-row {
            display: flex;
            gap: 10px;
            margin-bottom: 10px;
        ...
        /* â”€â”€ Receipt tear (signature) â”€â”€ */
        .tear {
            position: relative;
            height: 22px;
